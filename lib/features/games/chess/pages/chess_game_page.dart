...
class _ChessGamePageState extends BaseGamePageState<ChessGamePage> {
  ...
  //   //   showToast(1, "Its ${getUsername(currentPlayerId)}'s turn");
  //   //   return;
  //   // }
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.only(
                ...
                bottomLeft: (pindex == 0 && chesses.length <= 8) || pindex == 8
                    ? const Radius.circular(10)
                    : Radius.zero,
                topRight: pindex == 7 ||
