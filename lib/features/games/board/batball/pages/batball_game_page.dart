...
// import 'package:gamesarena/features/games/batball/models/batball.dart';
...
//   StreamSubscription<List<Player>>? playingSub;
//   double padding = 0;
...
//     playingSub = fs.readPlayers(gameId).listen((players) async {
...
//       }
//       String action = getAction(players);
//       if (action == "pause") {
//         if (!paused) {
//           pauseGame(true);
//         }
...
//         restartGame(true);
//       }
//       String newgame = getChangedGame(players);
...
//     } else {
//       if (gameId != "" && matchId != "") {
//         fs.pauseGame(gameId, matchId, players, id, maxGameTime - gameTime);
//       }
//     }
//   }
...
//       }
//     } else {
//       fs.changeGame(game, gameId, matchId, players, id, maxGameTime - gameTime);
//     }
//   }

//   void leaveMatch([bool act = false]) {
//     if (act || gameId == "") {
//       Navigator.of(context).pop();
//     } else {
//       if (gameId != "" && matchId != "") {
//         fs.leaveMatch(gameId, matchId, players, gameTime < maxGameTime, id,
...
//   void selectNewGame(newGame) async {
...
//         Fluttertoast.showToast(
//             msg:
//                 "You are currently players $newgame. Choose another game to change to");
//         return;
//       }
//       changeGame(newgame);
//     }
...
//   void moveBall() {
//     //if (gameMode != GameMode.players) return;
//     Direction hDir =
...
//       if (gameMode == GameMode.players) moveBall();
//     });
