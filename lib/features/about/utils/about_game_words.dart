...
Map<String, GameInfo> gamesInfo = {
  ...
  whotGame: GameInfo(
      ...
      rules: [
        ...
        "Player is only allow to play when it is players's turn",
      ...
      howtoplay: [
        "Tap any card to open your cards and don't reveal to your opponent and note cards automatically closes after players except when players online game to avoid unnecessary card revealing",
